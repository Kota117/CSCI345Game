...
HEADERS= $(SRC)/Exception.hpp $(SRC)/Game.hpp $(SRC)/MediaManager.hpp $(SRC)/Particle.hpp $(SRC)/Animation.hpp $(SRC)/Wave.hpp $(SRC)/Player.hpp $(SRC)/NPC.hpp $(SRC)/Config.hpp $(SRC)/Character.hpp $(SRC)/Tile.hpp $(SRC)/Map.hpp
