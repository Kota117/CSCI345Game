...
HEADERS= $(SRC)/Exception.hpp $(SRC)/Game.hpp $(SRC)/MediaManager.hpp $(SRC)/Particle.hpp $(SRC)/Animation.hpp $(SRC)/Wave.hpp $(SRC)/Player.hpp $(SRC)/Entity.hpp $(SRC)/Config.hpp
